...
class SimulationController:
    ...
    def __init__(self, map_instance, control_panel=None):
    ...
    def run_simulation(self):
        ...
        self.map.robot = Robot(self.map.map_model.start_position, self.map.map_view.width, self.map.map_view.height)  # Create robot instance with map dimensions
        ...
        self.map.robot.draw()
        self.map.robot.update_motion(self.map.map_model.obstacles, self.map.map_model.end_position) # Start motion update with required arguments
